...
#define ACPI_VENDOR_STRINGS                 0x01//选择厂商定制接口(OEM特定接口)
#define ACPI_FEATURE_STRINGS                0x02//选择ACPI标准特性接口
#define ACPI_ENABLE_INTERFACES              0x00//启用选定接口(默认值)
#define ACPI_DISABLE_INTERFACES             0x04//禁用选定接口

#define ACPI_DISABLE_ALL_VENDOR_STRINGS     (ACPI_DISABLE_INTERFACES | ACPI_VENDOR_STRINGS)//禁用所有厂商定制接口
#define ACPI_DISABLE_ALL_FEATURE_STRINGS    (ACPI_DISABLE_INTERFACES | ACPI_FEATURE_STRINGS)//禁用所有标准特性接口
#define ACPI_DISABLE_ALL_STRINGS            (ACPI_DISABLE_INTERFACES | ACPI_VENDOR_STRINGS | ACPI_FEATURE_STRINGS)//禁用所有接口
#define ACPI_ENABLE_ALL_VENDOR_STRINGS      (ACPI_ENABLE_INTERFACES | ACPI_VENDOR_STRINGS)//启用所有厂商接口
#define ACPI_ENABLE_ALL_FEATURE_STRINGS     (ACPI_ENABLE_INTERFACES | ACPI_FEATURE_STRINGS)//启用所有标准特性
#define ACPI_ENABLE_ALL_STRINGS             (ACPI_ENABLE_INTERFACES | ACPI_VENDOR_STRINGS | ACPI_FEATURE_STRINGS)//启用全部接口
